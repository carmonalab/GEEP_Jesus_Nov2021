...
facsMarkers <- qq(Sell,Il7r,Tcf7,Lef1,Klrg1,Cx3cr1,Xcl1,Il2ra,Id2,Tnfrsf9,Gzmk,Gzma,Gzmb,Gzmc,Tox,Pdcd1,Lag3,Havcr2,Entpd1,Mki67)

a <- VlnPlot(data.seurat.CD8, features = (facsMarkers[1:10]),stack = T, flip = T, fill.by = "ident", cols = clusterColors) + 
  theme(legend.position = "none", axis.title.x = element_blank()) 

b <- VlnPlot(data.seurat.CD8, features = (facsMarkers[11:20]),stack = T, flip = T, fill.by = "ident", cols = clusterColors) + 
