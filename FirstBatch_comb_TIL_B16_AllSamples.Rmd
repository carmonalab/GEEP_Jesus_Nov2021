...
markers4vs5 <- FindMarkers(data.seurat.CD8.projected.Tex,ident.1 = "C4",ident.2 = "C5",test.use = "MAST", min.diff.pct = 0.01,logfc.threshold = 0.25, min.pct=0.05, assay="RNA")
```
...
EnhancedVolcano(markers4vs5,
    ...
    x = 'avg_log2FC',
    y = 'p_val',FCcutoff = 1, drawConnectors = T, maxoverlapsConnectors = 50, pCutoff = 1e-10)
ggsave("pdf/Tex.c4vsc5.volcano.pdf",width = 6,height = 6)
